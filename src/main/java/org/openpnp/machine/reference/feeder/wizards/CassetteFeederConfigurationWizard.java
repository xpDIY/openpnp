...
public class CassetteFeederConfigurationWizard extends AbstractConfigurationWizard {
    ...
    public CassetteFeederConfigurationWizard(CassetteFeeder feeder) {
        ...
        btnDiscover.setToolTipText(
                "Automatically discover feeders that has been plug into the base plate.");
        ...
        textFieldOrientation.setToolTipText(
                "Sets the orientation of the feeder in degree. Can only be one of 0,90,180,270");
    ...
    private Action discoverFeederAction = new AbstractAction("Discovery") {
        {
    ...
    private Action saveFeederAction = new AbstractAction("SaveFeder") {
        {
            putValue(Action.SHORT_DESCRIPTION, "<html>Save current settings to feeder.</html>");
        }
    ...
    public void createBindings() {
        ...
        addWrappedBinding(feeder, "baseplateOffsetZ", textFieldBaseplateOffsetZ, "text",
                lengthConverter);
        addWrappedBinding(feeder, "continuousRowCol", textFieldContinuousRowCol, "text",
                intConverter);
